...
- **Phase 1 — the object and the loop.** Migration (§11), freeze/preview/redeem, the formula page, the composer action. Dark behind `FEED_FORMULAS_ENABLED`. **SERVER HALF SHIPPED 2026-08-11** (§12); the two web surfaces — the `/f/[token]` page and the composer action — are the remainder.
