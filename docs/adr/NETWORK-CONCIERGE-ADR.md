...
- **ASSISTED (Phase 3, preferred) — BUILT DARK 2026-06-11 behind `MASTODON_ASSISTED_ENABLED`.** Guide the user through native signup on an *existing* instance, then OAuth-link (`provenance='assisted'`) — the AP analog of §6.1. The two Phase-3 unknowns both resolved in the 2026-06-11 spike:
