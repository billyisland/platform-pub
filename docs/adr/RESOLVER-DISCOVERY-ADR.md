...
**Status:** Accepted — phased; Phase 0 shipped 2026-07-10 (`gateway/tests/resolver-orchestration.test.ts` + the `nostr-search.ts` extraction + structural per-chain isolation `safeChain`)
