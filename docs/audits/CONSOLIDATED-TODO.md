...
Compiled 2026-07-06 from every non-archived doc at `22419d0`. **Re-verified and updated 2026-07-07 against `2ccfa35`** — the same-day Wave-2 (F9/F5/F4/F10/F14 + Wave 5, migrations 142–144) and Wave-3 (migrations 146–147) economy remediation, migration 145, and the external-author-history ship (migration 148) landed in between and resolved most of the original §1. Every remaining claim below was re-verified in source (file:line where it matters), not just against the docs.
