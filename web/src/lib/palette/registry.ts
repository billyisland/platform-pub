...
export const PALETTE_REGISTRY: PaletteEntry[] = [
  ...
  { slug: 'spring-walls-dk', hex: '#14331E', label: 'Feed scheme Spring (dark) — walls & bar (deep forest frame)' },
  { slug: 'spring-interior-dk', hex: '#1C3F28', label: 'Feed scheme Spring (dark) — interior (verdant night ground)' },
  { slug: 'spring-card-dk', hex: '#244A30', label: 'Feed scheme Spring (dark) — card surface (mossy lifted well)' },
  ...
  { slug: 'summer-walls-dk', hex: '#0D2A4A', label: 'Feed scheme Summer (dark) — walls & bar (deep ocean frame)' },
  { slug: 'summer-interior-dk', hex: '#2E2A1C', label: 'Feed scheme Summer (dark) — interior (warm dusk ground — the warm/cool seam)' },
  { slug: 'summer-card-dk', hex: '#403524', label: 'Feed scheme Summer (dark) — card surface (warm sand-at-night well)' },
  ...
  { slug: 'autumn-walls-dk', hex: '#3A160B', label: 'Feed scheme Autumn (dark) — walls & bar (deep oxblood frame)' },
  { slug: 'autumn-interior-dk', hex: '#4A2418', label: 'Feed scheme Autumn (dark) — interior (dark clay ground)' },
  { slug: 'autumn-card-dk', hex: '#5A3122', label: 'Feed scheme Autumn (dark) — card surface (warm rust lifted well)' },
