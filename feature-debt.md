...
**Active branch:** `workspace-experiment` (slices 1–23 complete, not merged to master, not browser-tested — Postgres down on dev machine at time of last work). Decision pending: merge or retire.
